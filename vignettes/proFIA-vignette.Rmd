...
abline(h=band_list[,c("mzmin","mzmax")],lwd=0.5,lty=2,col="purple")
```
You may also spot a too low value of dmz if there is not enough data point on the distribution of group intensities (see the package vignette).
